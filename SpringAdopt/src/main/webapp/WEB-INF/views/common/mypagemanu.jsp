...
<c:set var="loginoutlink" value="${sessionScope.id==null ? '/login/mypagemain' : '/login/signout'}"/>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarsFurni">
					<ul id="gnb" class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
						...
						<li><a class="nav-item nav-link" href="<c:url value='/login/mypagemain'/>">나의정보</a></li>
					<%-- 	<li class="nav-item dropdown"><a class="nav-link" data-bs-toggle="dropdown" href="<c:url value='/login/wishlist'/>">위시리스트</a>
							<ul class="dropdown-menu rounded">
						...
						<li><a class="nav-link" href="<c:url value='/login/wishlist'/>">위시리스트</a></li>
						<li><a class="nav-link" href="<c:url value='/login/mypost'/>">내 게시물</a></li>
					</ul>

					<ul class="custom-navbar-cta navbar-nav mb-2 mb-md-0 ms-5">
						<li><a class="nav-link"  href="<c:url value='${loginoutlink}' />">${signout}<img src="<c:url value='/resources/images/login.svg'/>" alt="로그인"></a></li>
						<li><a class="nav-link" href="<c:url value='/login/mypagemain'/>"><img src="<c:url value='/resources/loginimages/mypage.png'/>" alt="회원가입"></a></li>
