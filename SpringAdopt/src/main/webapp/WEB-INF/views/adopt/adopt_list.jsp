 ...
 <div class="container"> 		 
    ...
    <div class="row">
      ...
      <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <div class="bg-white rounded shadow-sm"><a href="<c:url value='/adopt/adopt_view'/>"><img src="<c:url value='/resources/images/cat.jpg'/>" alt="" class="img-fluid card-img-top"></a>
          <div class="p-4">
      ...
      <!-- Gallery item -->
      <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <div class="bg-white rounded shadow-sm"><img src="<c:url value='/resources/images/cat.jpg'/>" alt="" class="img-fluid card-img-top">
          <div class="p-4">
            <h5 class="text-center"> <a href="#" class="text-dark fw-bold">초코</a></h5>
            <p class="text-center mb-0">품종 : 말티즈 </p>
            <div class="rounded-pill bg-light1 px-3 py-1 mt-2 ">
